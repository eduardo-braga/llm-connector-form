  ...
  return (
    <Card className="max-w-3xl mx-auto mt-8 shadow-2xl rounded-2xl p-4">
      <CardContent>
        ...
        <Button className="w-full bg-black hover:bg-black hover:bg-neutral-800 text-white mt-6" variant="default" size="lg" onClick={() => window.alert('Connector successfully saved!')}>Save</Button>
      </CardContent>
    </Card>
  );
}
